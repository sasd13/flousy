...
public class CustomerDAO extends SQLiteTableDAO<Customer> implements flousy.db.dao.CustomerDAO {
    ...
    public void insert(Customer customer) {
        getDB().insert(CUSTOMER_TABLE_NAME, null, getContentValues(customer));
    }

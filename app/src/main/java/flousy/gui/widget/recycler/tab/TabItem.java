 ...
 */
public class TabItem extends RecyclerItem {
    ...
    public void inflate(ViewStub viewStub) {
        ...
        this.nameTextView = (TextView) this.view.findViewById(R.id.tabitem_textview_name);
        this.nameTextView.setText(this.nameText);

        this.priceTextView = (TextView) this.view.findViewById(R.id.tabitem_textview_price);
        this.priceTextView.setText(this.priceText);
